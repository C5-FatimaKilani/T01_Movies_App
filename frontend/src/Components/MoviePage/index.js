...
favorites.push(details.id)
 ...
 : {details.vote_average}</ListGroup.Item>
   <ListGroup.Item>Running time : {details.runtime}minutes </ListGroup.Item>
  
 </ListGroup>
 <Card.Body>
   <Card.Link href="#"><svg style={{color:"black"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
